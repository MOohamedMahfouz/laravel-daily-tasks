...
class User extends Authenticatable
{
    ...
    public function comments()
    {
        ...
        return $this->hasManyThrough(
            Comment::class, // The related model
            Task::class, // The intermediate model
            'users_id', // Foreign key on the intermediate model
            'task_id', // Foreign key on the related model
